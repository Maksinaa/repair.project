            ...
            <table class="table table-sm">
              ...
              @forelse($items as $item)
                  <tr>
                    ...
                    <td class="text-end">
                      <a class="btn btn-sm btn-primary" id="show" href="{{ route('admin.details.show', $item->id) }}">
                        Детали
                      </a>
                      <a class="btn btn-sm btn-secondary" id="edit" href="{{ route('admin.details.edit',  $item->id ) }}">
                        Редактировать
                      </a>&nbsp;
                      <form action="{{ route('admin.details.destroy', $item->id) }}" method="post" class="float-end">
                        @csrf
                        @method('delete')
